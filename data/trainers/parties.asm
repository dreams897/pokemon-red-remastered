...
BrockGroup:
	...
	db 12, GEODUDE,    DEFENSE_CURL, TACKLE, NO_MOVE, NO_MOVE
	db 14, ONIX,       BIDE, SCREECH, TACKLE, BIND
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 18, STARYU,     TACKLE, WATER_GUN, RAPID_SPIN, RECOVER
	db 21, STARMIE,    TACKLE, BUBBLEBEAM, RAPID_SPIN, RECOVER
	db -1 ; end
...
BugCatcherGroup:
	...
	db 21, BUTTERFREE, CONFUSION, POISONPOWDER, SUPERSONIC, WHIRLWIND
	db -1 ; end
...
SuperNerdGroup:
	...
	db 12, KOFFING,   POISON_GAS, SMOKESCREEN, TACKLE, SMOG
	db -1 ; end
...
TeamRocketGroup:
	; TEAM_ROCKET (1)
	db "@", TRAINERTYPE_MOVES
	db 14, EKANS,      WRAP, LEER, POISON_STING, BITE
	db 14, MEOWTH,     SCRATCH, GROWL, BITE, PAY_DAY
	db 14, KOFFING,    POISON_GAS, TACKLE, SMOG, SMOKESCREEN
	db -1 ; end
	
	; TEAM_ROCKET (2)
	db "@", TRAINERTYPE_MOVES
	db 25, EKANS,      BITE, LEER, POISON_STING, GLARE
	db 25, MEOWTH,     SCRATCH, GROWL, BITE, PAY_DAY
	db 25, KOFFING,    POISON_GAS, TACKLE, SMOG, TOXIC
	db -1 ; end
	
	; TEAM_ROCKET (3)
	db "@", TRAINERTYPE_MOVES
	db 27, ARBOK,      ACID, POISON_STING, WRAP, BITE
	db 27, MEOWTH,     GROWL, SCREECH, BITE, PAY_DAY
	db 27, WEEZING,    SLUDGE, TACKLE, HAZE, SMOKESCREEN
	db -1 ; end
	
	; TEAM_ROCKET (4)
	db "@", TRAINERTYPE_MOVES
	db 31, ARBOK,      ACID, GLARE, WRAP, BITE
	db 31, MEOWTH,     FURY_SWIPES, SCREECH, BITE, PAY_DAY
	db 31, WEEZING,    SLUDGE, TACKLE, SELFDESTRUCT, SMOKESCREEN
	db -1 ; end
	
GiovanniGroup:
	; GIOVANNI (1)
	db "GIOVANNI@", TRAINERTYPE_MOVES
	db 25, ONIX,    ROCK_THROW, BIND, RAGE, SCREECH
	db 25, RHYHORN, HORN_ATTACK, TAIL_WHIP, SCARY_FACE, STOMP
	db 29, PERSIAN, PAY_DAY, SCRATCH, BITE, GROWL
	db -1 ; end
	
	; GIOVANNI (2)
	db "GIOVANNI@", TRAINERTYPE_MOVES
	db 37, NIDORINO, DOUBLE_KICK, POISON_STING, FOCUS_ENERGY, FURY_ATTACK
	db 37, RHYHORN, HORN_ATTACK, TACKLE, SCARY_FACE, STOMP
	db 35, PERSIAN, PAY_DAY, SCRATCH, BITE, FURY_SWIPES
