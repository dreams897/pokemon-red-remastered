...
;\6: pager service flag: TRUE to prevent phone calls
...
MapGroup_Olivine:
	...
	map OlivinePokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_OLIVINE_CITY, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route38EcruteakGate, TILESET_GATE, GATE, LANDMARK_ROUTE_38, MUSIC_ROUTES3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route38, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_38, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route39, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_39, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Mahogany:
	...
	map MahoganyPokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_MAHOGANY_TOWN, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Dungeons:
	...
	map ViridianForest, TILESET_VIRIDIAN_FOREST, FOREST, LANDMARK_VIRIDIAN_FOREST, MUSIC_DUNGEON2, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map DiglettsCave, TILESET_CAVE_KANTO, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DIGLETTS_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map DiglettsCaveRoute2, TILESET_CAVE_KANTO, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DIGLETTS_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map DiglettsCaveRoute11, TILESET_CAVE_KANTO, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DIGLETTS_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map MtMoon1F, TILESET_CAVE_KANTO, CAVE, LANDMARK_MT_MOON, MUSIC_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map MtMoonB1F, TILESET_CAVE_KANTO, CAVE, LANDMARK_MT_MOON, MUSIC_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map MtMoonB2F, TILESET_CAVE_KANTO, CAVE, LANDMARK_MT_MOON, MUSIC_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map UndergroundPath, TILESET_UNDERGROUND, GATE, LANDMARK_UNDERGROUND_PATH, MUSIC_ROUTES1, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map RockTunnel1F, TILESET_DARK_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_DUNGEON3, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	map RockTunnelB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_DUNGEON3, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	map SafariZoneFuchsiaGateBeta, TILESET_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneBeta, TILESET_PARK, CAVE, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map VictoryRoad, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Ecruteak:
	...
	map EcruteakPokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Blackthorn:
	...
	map BlackthornPokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_BLACKTHORN_CITY, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MoveDeletersHouse, TILESET_HOUSE, INDOOR, LANDMARK_BLACKTHORN_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route45, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_45, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI_2
	map Route46, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_46, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Cinnabar:
	...
	map CinnabarPokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarPokecenter2FBeta, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route19FuchsiaGate, TILESET_GATE, GATE, LANDMARK_ROUTE_19, MUSIC_ROUTES3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SeafoamGym, TILESET_CAVE, INDOOR, LANDMARK_SEAFOAM_ISLANDS, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map Route19, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_19, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route20, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_20, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route21, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_21, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_Cerulean:
	...
	map CeruleanGymBadgeSpeechHouse, TILESET_SHIP_KANTO, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanBerrySpeechHouse, TILESET_SHIP_KANTO, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanBikeShop, TILESET_CLUB_KANTO, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanTrashedHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanTradeSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanPokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanPokecenter2FBeta, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanGym, TILESET_GYM_CERULEAN, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map CeruleanMart, TILESET_MART_KANTO, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BillsHouse, TILESET_INTERIOR, INDOOR, LANDMARK_ROUTE_25, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route4, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_4, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route9, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_9, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	...
	map CeruleanCity, TILESET_KANTO, TOWN, LANDMARK_CERULEAN_CITY, MUSIC_CITIES2, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	assert_table_length NUM_CERULEAN_MAPS

MapGroup_Azalea:
	table_width MAP_LENGTH, MapGroup_Azalea
	map AzaleaPokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_AZALEA_TOWN, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route33, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_ROUTE_33, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Violet:
	...
	map Route32, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_32, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
	map Route35, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_35, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route36, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_36, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route37, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_37, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map VioletPokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_VIOLET_CITY, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route32RuinsOfAlphGate, TILESET_GATE, GATE, LANDMARK_ROUTE_32, MUSIC_ROUTES3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route32Pokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_ROUTE_32, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route35GoldenrodGate, TILESET_GATE, GATE, LANDMARK_ROUTE_35, MUSIC_ROUTES3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route35NationalParkGate, TILESET_GATE, INDOOR, LANDMARK_ROUTE_35, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route36RuinsOfAlphGate, TILESET_GATE, GATE, LANDMARK_ROUTE_36, MUSIC_ROUTES3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Goldenrod:
	...
	map Route34, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_ROUTE_34, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map GoldenrodPokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokecomCenterAdminOfficeMobile, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map IlexForestAzaleaGate, TILESET_GATE, GATE, LANDMARK_ROUTE_34, MUSIC_ROUTES3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route34IlexForestGate, TILESET_GATE, GATE, LANDMARK_ROUTE_34, MUSIC_ROUTES3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Vermilion:
	...
	map Route6, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_6, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route11, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_11, MUSIC_ROUTES4, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route11Gate1F, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_11, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route11Gate2F, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_11, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionCity, TILESET_KANTO, TOWN, LANDMARK_VERMILION_CITY, MUSIC_VERMILION, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map VermilionFishingSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionPokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionPokecenter2FBeta, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonFanClub, TILESET_INTERIOR, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionTradeHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionMart, TILESET_MART_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionPidgeyHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionGym, TILESET_GAME_CORNER, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map Route6SaffronGate, TILESET_GATE, GATE, LANDMARK_ROUTE_6, MUSIC_ROUTES3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route6UndergroundPathEntrance, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_6, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_VERMILION_MAPS

MapGroup_Pallet:
	table_width MAP_LENGTH, MapGroup_Pallet
	map Route1, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_1, MUSIC_ROUTES1, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map Route3, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_3, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PewterCity, TILESET_KANTO, TOWN, LANDMARK_PEWTER_CITY, MUSIC_CITIES1, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PewterNidoranSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterGym, TILESET_GYM_PEWTER, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterMart, TILESET_MART_KANTO, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterPokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterPokecenter2FBeta, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterMuseum1F, TILESET_MUSEUM, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterMuseum2F, TILESET_MUSEUM, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MtMoonPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_ROUTE_4, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_PEWTER_MAPS

MapGroup_SSAnne:
	table_width MAP_LENGTH, MapGroup_SSAnne
	map VermilionDock, TILESET_PORT_KANTO, ROUTE, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map SSAnne1F, TILESET_SHIP_KANTO, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne2F, TILESET_SHIP_KANTO, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne3F, TILESET_SHIP_KANTO, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneB1F, TILESET_SHIP_KANTO, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneBow, TILESET_SHIP_KANTO, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SSAnneKitchen, TILESET_SHIP_KANTO, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneCaptainsRoom, TILESET_SHIP_KANTO, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne1FRooms, TILESET_SHIP_KANTO, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne2FRooms, TILESET_SHIP_KANTO, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneB1FRooms, TILESET_SHIP_KANTO, INDOOR, LANDMARK_SS_ANNE, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_SS_ANNE_MAPS
...
MapGroup_Indigo:
	...
	map IndigoPlateauPokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	...
	map Route18, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_18, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FuchsiaCity, TILESET_KANTO, TOWN, LANDMARK_FUCHSIA_CITY, MUSIC_CITIES2, FALSE, PALETTE_AUTO, FISHGROUP_GYARADOS
	map FuchsiaMart, TILESET_MART_KANTO, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneMainOffice, TILESET_GAME_CORNER, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaGym, TILESET_LAB, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map BillsBrothersHouse, TILESET_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaPokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaPokecenter2FBeta, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneWardensHome, TILESET_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map Route8, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_8, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route12, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_12, MUSIC_ROUTES4, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH_NO_SWARM
	map Route10, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_10, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map RockTunnelPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_ROUTE_10, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PowerPlant, TILESET_FACILITY, INDOOR, LANDMARK_POWER_PLANT, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderTown, TILESET_KANTO, TOWN, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LavenderPokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderPokecenter2FBeta, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map LavenderMart, TILESET_MART_KANTO, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SoulHouse, TILESET_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower1F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_LAV_POKEMON_TOWER, MUSIC_LAVENDER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route8SaffronGate, TILESET_GATE, GATE, LANDMARK_ROUTE_8, MUSIC_ROUTES3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route12SuperRodHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_12, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Silver:
	...
	map SilverCavePokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_SILVER_CAVE, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_CableClub:
	...
	map Pokecenter2F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_SPECIAL, MUSIC_POKECENTER, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Celadon:
	...
	map CeladonCity, TILESET_KANTO, TOWN, LANDMARK_CELADON_CITY, MUSIC_CITIES2, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map CeladonDeptStore1F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore2F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore3F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore4F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore5F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore6F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStoreElevator, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonMansion1F, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonMansion2F, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonMansion3F, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonMansionRoof, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonMansionRoofHouse, TILESET_HOUSE, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonPokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CELADON_CITY, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonPokecenter2FBeta, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeladonGameCornerPrizeRoom, TILESET_GAME_CORNER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonGym, TILESET_TRAIN_STATION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonCafe, TILESET_GAME_CORNER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route16FuchsiaSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_16, MUSIC_CELADON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route16Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_16, MUSIC_ROUTES3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route7SaffronGate, TILESET_GATE, GATE, LANDMARK_ROUTE_7, MUSIC_ROUTES3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route17Route18Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_17, MUSIC_ROUTES3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_CELADON_MAPS

MapGroup_Cianwood:
	table_width MAP_LENGTH, MapGroup_Cianwood
	map Route40, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_40, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route41, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_41, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	...
	map CianwoodPokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CIANWOOD_CITY, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route40BattleTowerGate, TILESET_GATE, GATE, LANDMARK_BATTLE_TOWER, MUSIC_ROUTES3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map Route2, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_2, MUSIC_ROUTES1, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route22, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_22, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map ViridianCity, TILESET_KANTO, TOWN, LANDMARK_VIRIDIAN_CITY, MUSIC_CITIES1, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map ViridianGym, TILESET_TRAIN_STATION, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianNicknameSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianSchoolHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianMart, TILESET_MART_KANTO, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianPokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianPokecenter2FBeta, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestNorthGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_2, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route2NuggetHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_ROUTE_2, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route2Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestSouthGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_2, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VictoryRoadGate, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_22, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Saffron:
	...
	map Route5, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_5, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SaffronCity, TILESET_KANTO, TOWN, LANDMARK_SAFFRON_CITY, MUSIC_CITIES1, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FightingDojo, TILESET_TRAIN_STATION, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronGym, TILESET_UNDERGROUND, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronMart, TILESET_MART_KANTO, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronPokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronPokecenter2FBeta, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MrPsychicsHouse, TILESET_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronMagnetTrainStation, TILESET_TRAIN_STATION, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo1F, TILESET_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CopycatsHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CopycatsHouse2F, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route5UndergroundPathEntrance, TILESET_GATE_KANTO, GATE, LANDMARK_ROUTE_5, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route5SaffronGate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_5, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route5CleanseTagHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_ROUTE_5, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_SAFFRON_MAPS

MapGroup_Cherrygrove:
	table_width MAP_LENGTH, MapGroup_Cherrygrove
	map Route30, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_30, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route31, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_31, MUSIC_ROUTES3, FALSE, PALETTE_AUTO, FISHGROUP_POND
	...
	map CherrygrovePokecenter1F, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_POKECENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route31VioletGate, TILESET_GATE, GATE, LANDMARK_ROUTE_31, MUSIC_ROUTES3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
