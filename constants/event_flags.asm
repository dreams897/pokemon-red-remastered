...
; Johto story events
	...
	const_skip ; const EVENT_GOT_ITEMFINDER --> Changed to Route 11
	const_skip ; const EVENT_GOT_BICYCLE --> Used in Cerulean City
	...
	const EVENT_TOLD_ELM_ABOUT_TOGEPI_OVER_THE_PAGER
...
; Pewter City
	...
	const EVENT_BEAT_PEWTER_GYM_TRAINER_JERRY
	const EVENT_BEAT_PEWTER_GYM_TRAINER_TONY
	const EVENT_GOT_TM34_BIDE
	const EVENT_BEAT_BROCK
	
; Cerulean City events
	const EVENT_CERULEAN_RIVAL_WANTS_BATTLE
	const EVENT_BEAT_RIVAL_CERULEAN
	const EVENT_BEAT_CERULEAN_ROCKET_THIEF
	const EVENT_BEAT_CERULEAN_GYM_TRAINER_JAMES
	const EVENT_BEAT_CERULEAN_GYM_TRAINER_JILL
	const EVENT_BEAT_CERULEAN_GYM_TRAINER_LISA
...
; Route 3 events
	const EVENT_BEAT_ROUTE_3_BUG_CATCHER_FOREST
	const EVENT_BEAT_ROUTE_3_YOUNGSTER_BEN
	const EVENT_BEAT_ROUTE_3_LASS_ALICE
	const EVENT_BEAT_ROUTE_3_BUG_CATCHER_JOSH
	const EVENT_BEAT_ROUTE_3_YOUNGSTER_MIKEY
	const EVENT_BEAT_ROUTE_3_LASS_CARRIE
	const EVENT_BEAT_ROUTE_3_BUG_CATCHER_WADE
	const EVENT_BEAT_ROUTE_3_LASS_CONNIE
...
; Route 6 events
	const EVENT_BEAT_ROUTE_6_KEIGO
	const EVENT_BEAT_ROUTE_6_RICKY
	const EVENT_BEAT_ROUTE_6_NANCY
	const EVENT_BEAT_ROUTE_6_ELIJAH
	const EVENT_BEAT_ROUTE_6_ISABELLE
	const EVENT_BEAT_ROUTE_6_JEFF
...
; Route 11 events
	const EVENT_BEAT_ROUTE_11_YOUNGSTER1
	const EVENT_BEAT_ROUTE_11_YOUNGSTER2
	const EVENT_BEAT_ROUTE_11_YOUNGSTER3
	const EVENT_BEAT_ROUTE_11_YOUNGSTER4
	const EVENT_BEAT_ROUTE_11_GAMBLER1
	const EVENT_BEAT_ROUTE_11_GAMBLER2
	const EVENT_BEAT_ROUTE_11_GAMBLER3
	const EVENT_BEAT_ROUTE_11_GAMBLER4
	const EVENT_BEAT_ROUTE_11_ENGINEER1
	const EVENT_BEAT_ROUTE_11_ENGINEER2
...
; Route 24 events
	...
	const EVENT_BEAT_ROUTE_24_JRTRAINER_M_SEAN
	const EVENT_BEAT_ROUTE_24_LASS_AMY
	const EVENT_BEAT_ROUTE_24_YOUNGSTER_RYAN
	const EVENT_BEAT_ROUTE_24_JRTRAINER_M_ALEX
	const EVENT_BEAT_ROUTE_24_LASS_EMILY
	const EVENT_BEAT_ROUTE_24_BUG_CATCHER_JAKE
	const EVENT_NUGGET_REWARD_AVAILABLE
	
; Route 25 events
	const EVENT_BEAT_ROUTE_25_HIKER_BENJAMIN
	const EVENT_BEAT_ROUTE_25_HIKER_ERIK
	const EVENT_BEAT_ROUTE_25_YOUNGSTER_GORDON
	const EVENT_BEAT_ROUTE_25_YOUNGSTER_WARREN
	const EVENT_BEAT_ROUTE_25_LASS_MICHELLE
	const EVENT_BEAT_ROUTE_25_HIKER_ANTHONY
	const EVENT_BEAT_ROUTE_25_JRTRAINER_M_JEFFREY
	const EVENT_BEAT_ROUTE_25_YOUNGSTER_IAN
	const EVENT_BEAT_ROUTE_25_LASS_DANA
	const EVENT_ROUTE_25_HIDDEN_FAST_BALL
	const EVENT_ROUTE_25_TM_SEISMIC_TOSS ; TODO
...
; Viridian Forest events
	const EVENT_BEAT_VIRIDIAN_FOREST_BUG_CATCHER_CALEB
	const EVENT_BEAT_VIRIDIAN_FOREST_BUG_CATCHER_DYLAN
	const EVENT_BEAT_VIRIDIAN_FOREST_BUG_CATCHER_FOREST
	const EVENT_VIRIDIAN_FOREST_POKE_BALL
	const EVENT_VIRIDIAN_FOREST_POTION
	const EVENT_VIRIDIAN_FOREST_ANTIDOTE
	
; Mt. Moon events
	const EVENT_MT_MOON_1F_TM_WATER_GUN
	...
	const EVENT_BEAT_MT_MOON_1F_BUG_CATCHER_KEN
	const EVENT_BEAT_MT_MOON_1F_LASS_LAURA
	const EVENT_BEAT_MT_MOON_1F_SUPER_NERD_DAVE
	const EVENT_BEAT_MT_MOON_1F_BUG_CATCHER_BENNY
	const EVENT_BEAT_MT_MOON_1F_LASS_SHANNON
	const EVENT_BEAT_MT_MOON_1F_YOUNGSTER_SAMUEL
	const EVENT_BEAT_MT_MOON_1F_HIKER_RUSSELL
	const EVENT_BEAT_MT_MOON_EXIT_SUPER_NERD
	const EVENT_MT_MOON_B2F_HP_UP
	const EVENT_MT_MOON_B2F_TM_DYNAMIC_PUNCH
	const EVENT_BEAT_MT_MOON_B2F_ROCKET_1
	const EVENT_BEAT_MT_MOON_B2F_ROCKET_2
	const EVENT_BEAT_MT_MOON_B2F_ROCKET_3
	const EVENT_BEAT_MT_MOON_B2F_ROCKET_4
	const EVENT_BEAT_MT_MOON_B2F_SUPER_NERD_MIGUEL
	const EVENT_GOT_DOME_FOSSIL
	const EVENT_GOT_HELIX_FOSSIL
	const EVENT_TEAM_ROCKET_APPEARED_MT_MOON

; S.S. Anne events
	const EVENT_BEAT_SS_ANNE_EDMOND
	const EVENT_BEAT_SS_ANNE_TREVOR
	...
	const EVENT_S_S_ANNE_HIDDEN_GREAT_BALL
	const EVENT_S_S_ANNE_RIVAL_WANTS_BATTLE
	const EVENT_BEAT_RIVAL_S_S_ANNE
...
; Pager events
	const EVENT_JACK_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_BEVERLY_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_HUEY_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	...
	const EVENT_GAVEN_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_BETH_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_JOSE_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_REENA_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_JOEY_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_WADE_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_RALPH_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_LIZ_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_ANTHONY_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_TODD_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_GINA_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_IRWIN_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_ARNIE_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_ALAN_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const_skip ; unused
	const_skip ; unused
	const EVENT_DANA_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_CHAD_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_DEREK_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_TULLY_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_BRENT_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused
	const EVENT_TIFFANY_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_VANCE_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_WILTON_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_KENJI_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_PARRY_ASKED_FOR_PAGER_NUMBER
	const_skip ; unused in Crystal
	const EVENT_ERIN_ASKED_FOR_PAGER_NUMBER
	const EVENT_BUENA_OFFERED_HER_PAGER_NUMBER_NO_BLUE_CARD
	const_skip ; unused
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_BUENA_OFFERED_HER_PAGER_NUMBER
...
; Kanto Gym Leaders
	const_skip ; Used earlier EVENT_BEAT_BROCK
	const_skip ; Used earlier EVENT_BEAT_MISTY
	const_skip ; Used earlier EVENT_BEAT_LT_SURGE
	const_skip ; Used earlier EVENT_BEAT_ERIKA
	const EVENT_BEAT_JANINE
	const_skip ; Used earlier EVENT_BEAT_SABRINA
	const_skip ; Used earlier EVENT_BEAT_BLAINE
...
; Johto people
	...
	const_skip ; const EVENT_MET_BILL Used in Kanto events
...
; Kanto itemballs
	...
	const EVENT_ROUTE_4_TM_ROLLOUT
	const EVENT_HIDDEN_ETHER_MT_MOON_B2F
	const EVENT_HIDDEN_MOONSTONE_MT_MOON_B2F
